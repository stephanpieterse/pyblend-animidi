...
class animidi:
    ...
    def build_dataset_from_midi(self):
        ...
        pattern = pythonmidi.fileio.read_midifile(midifile)
    ...
    def main(self):
        ...
        # make a clean script and write basic info
        print("clearing the script output file...")
        with open(outputScriptName, 'w') as f:
            base_script = "#autogenerated. edit at own risk. pyblend-animidi \n"
            base_script += "#copyright stephan pieterse 2015. licenced under gpl3. \n"
